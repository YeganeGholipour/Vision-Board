...
urlpatterns = [
    path('board/', views.ViewBoard.as_view(), name='view_board'),
    path('sub-board/<int:pk>/', views.ViewDetailSubBoard.as_view(), name='view_sub_board'),
    path('sub-board-users/<int:pk>/', views.ViewDetailSubBoardUser.as_view(), name='view_sub_board_users'),
    path('create-sub-board/', views.ViewCreateSubBoard.as_view(), name='create_sub_board'),
